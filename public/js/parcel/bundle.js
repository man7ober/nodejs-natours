    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('warning', 'Logged out successfully 👋');
            window.setTimeout(function () {
              location.assign('/');
            }, 1000);
          }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFuN29iZXIiLCJhIjoiY2xrMjVuZGZrMGYzdjNycGpuZ2ptdGNwZiJ9.QJMtoK57oD0XuKo7EFA-mg';
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:8000/api/v1/users/updateMyPassword' : 'http://localhost:8000/api/v1/users/updateUser';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            if (type === 'password') {
              (0, _alert.showAlert)('success', 'Password updated successfully ✌️');
            } else {
              (0, _alert.showAlert)('success', 'Data updated successfully ✌️');
            }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          stripe = Stripe('pk_test_51NeVpTSCMD6YFv2K1svb0A7jusdCBT0f7qkMUtULcijePnzqhYwwQCvFmd2EFik0KCJIusfXSc0viRrdPuF40F9q00RJiStjV4'); // 2. Get checkout session from API
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10185" + '/');
